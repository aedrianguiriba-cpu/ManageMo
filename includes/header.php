...
<body>
<!-- Logo loader — shown until the page/assets finish loading (see footer.php) -->
<div id="skeletonLoader">
    <div class="sk-loader-wrap">
        <div class="sk-logo-ring">
            <img class="sk-logo-img" src="<?php echo BASE_URL; ?>assets/pics/logo.png" alt="Loading">
        </div>
        <div class="sk-loader-text">ManageMo</div>
    </div>
</div>
